...
# VARIBLES
menu = ("Set spool size", "View settings", "Test winder", "Save")
number_steps = 36 # SETS MAX RIGHT POSITION OF STEPPER (MENU 0)
...
def steps_per_rev(steps_per_turn):
    ...
    LCD_text_update(0, 0, str(number_steps), 4, 1, stp_trn)
    ...
    if reset_btn.value():
        ...
        if LCD_pos == 0:
            if list_pos == 3:
                ...
                list_pos+=1
                number_steps = spool_size[list_pos]
